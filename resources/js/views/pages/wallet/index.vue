...
export default {
  ...
  data() {
    return {
      ...
      setting: {
        name: true,
        name_e: true,
          total_value_stocks: true,
          total_closing_price: true,
      }, //Table columns
      filterSetting: ["name", "name_e", "total_value_stocks","total_closing_price"],
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/wallet?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.myData = l.data;
    ...
    getDataCurrentPage() {
      if (
        ...
        adminApi
          .get(
            `/wallet?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.myData = l.data;
     ...
     */
    resetModalEdit(id) {
      let edit = this.myData.find((e) => id == e.id);
      this.edit.name = edit.name;
      this.edit.name_e = edit.name_e;
      this.errors = {};
    },
    /**
     *  hidden Modal (edit)
        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("Wallet.WalletTable") }}</h4>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <b-form-checkbox v-model="setting.total_value_stocks" class="mb-1">
                      {{ $t("general.TotalShareBalanceWithAveragePrice") }}
                    </b-form-checkbox>
                      <b-form-checkbox v-model="setting.total_closing_price" class="mb-1">
                      {{ $t("general.totalShearBalanceWithClosingBrice") }}
                    </b-form-checkbox>
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            pagination.current_page == 1 ? 'none' : '',
                        }"
              ...
              <table class="table table-borderless table-hover table-centered m-0">
                <thead>
                  <tr>
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="myData.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="myData.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="myData.sort(sortString('-name_e'))"
                    ...
                    <th v-if="setting.total_value_stocks">
                      <div class="d-flex justify-content-center">
                        <span>{{ $t("general.TotalShareBalanceWithAveragePrice") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="myData.sort(sortString('total_value_stocks'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="myData.sort(sortString('-total_value_stocks'))"
                    ...
                    <th v-if="setting.total_closing_price">
                      <div class="d-flex justify-content-center">
                        <span>{{ $t("general.totalShearBalanceWithClosingBrice") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="myData.sort(sortString('total_closing_price'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="myData.sort(sortString('-total_closing_price'))"
                ...
                <tbody v-if="myData.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.total_value_stocks">
                      <h5 class="m-0 font-weight-normal">{{ data.total_value_stocks }}</h5>
                    </td>
                      <td v-if="setting.total_closing_price">
                      <h5 class="m-0 font-weight-normal">{{ data.total_closing_price }}</h5>
                    </td>
                    <td>
                      <div class="btn-group">
                        <button
