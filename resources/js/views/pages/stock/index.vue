...
export default {
    ...
    data() {
        return {
            ...
            debounce: {},
            pagination: {},
            stockMarketTypeAr: [], //Fetch Parent Table Data
            stockSectorTypeAr: [], //Fetch Parent Table Data
            ...
            setting: {
                name: true,
                name_e: true,
                stock_market_id: true,
                sector_id: true,
                symbol: true,
            }, //Table columns
            filterSetting: ["name", "name_e", "symbol"],
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/stock?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
                    this.dataAr = l.data;
        ...
        getDataCurrentPage() {
            if (
                ...
                adminApi
                    .get(
                        `/stock?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.dataAr = l.data;
         ...
         */
        async resetModal() {
            await this.getStockSector();
            await this.getStockMarket();
            this.create = {
                name: "",
                name_e: "",
                stock_market_id: "",
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                let { name, name_e, stock_market_id, sector_id, symbol } =
                    this.edit;
                adminApi
                    .put(`/stock/${id}`, {
                        name,
        ...
        async resetModalEdit(id) {
            ...
            this.edit.stock_market_id = serverData.stock_market_id
                ? serverData.stock_market_id.id
                : "";

            this.edit.name = serverData.name;
            this.edit.name_e = serverData.name_e;
            this.edit.sector_id = serverData.sector_id
                ? serverData.sector_id.id
                : "";
            this.edit.symbol = serverData.symbol;
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
        ...
        async getStockMarket() {
            await adminApi
                ...
                .then((res) => {
                    let l = res.data;
                    this.stockMarketTypeAr = l.data;
                    // console.log(this.stockMarketTypeAr);
                })
                .catch((err) => {
                    Swal.fire({
                        icon: "error",
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        >
                                            ...
                                            <multiselect
                                                v-model="create.stock_market_id"
                                                :options="
                                                    stockMarketTypeAr.map(
                                                        (type) => type.id
                                                    )
                                                "
                                                :custom-label="
                                            ...
                                            <template
                                                v-if="errors.stock_market_id"
                                            >
                                                <ErrorMessage
                                                    v-for="(
                                                        errorMessage, index
                                                    ) in errors.stock_market_id"
                                                    :key="index"
                                                    >{{
                                                        errorMessage
                                                    }}</ErrorMessage
                            ...
                            >
                                <thead>
                                    <tr>
                                        ...
                                        <th v-if="setting.stock_market_id">
                                            <div
                                                class="d-flex justify-content-center"
                                            >
                                                <span>{{
                                ...
                                <tbody v-if="dataAr.length > 0">
                                    ...
                                    >
                                        ...
                                        <td v-if="setting.stock_market_id">
                                            <h5 class="m-0 font-weight-normal">
                                                {{
                                                    data.stock_market_id
                                                        ? $i18n.locale == "ar"
                                                            ? data
                                                                  .stock_market_id
                                                                  .name
