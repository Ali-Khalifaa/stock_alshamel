...
export default {
    page: {
        title: "Stock Sector",
        meta: [{ name: "description", content: "Stock Sector " }],
    },
    components: {
        Layout,
        PageHeader,
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/stock-sector?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
                    this.stockSectors = l.data;
                    this.stockSectorPagination = l.pagination;
        ...
        getDataCurrentPage() {
            if (
                this.current_page <= this.stockSectorPagination.last_page &&
                this.current_page != this.stockSectorPagination.current_page &&
                this.current_page
            ) {
                this.isLoader = true;
                let filter = "";
                ...
                adminApi
                    .get(
                        `/stock-sector?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.stockSectors = l.data;
        ...
        /**
         *  Bulk delete Stock Sector
         */
        bulkDeleteStockSector(id) {
            Swal.fire({
                title: `${this.$t("general.Areyousure")}`,
                text: `${this.$t("general.Youwontbeabletoreverthis")}`,
                type: "warning",
         ...
         */
        resetModalEdit(id) {
            let stockSectorField = this.stockSectors.find((e) => id == e.id);
            this.edit.name = stockSectorField.name;
            this.edit.name_e = stockSectorField.name_e;
                    ...
                    <div class="card-body">
                        ...
                        >
                            <h4 class="header-title">
                                {{ $t("StockSector.StockSectorTable") }}
                            </h4>
                            <div
                            ...
                            >
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <button
                                        ...
                                        v-if="checkAll.length > 1"
                                        @click.prevent="
                                            bulkDeleteStockSector(checkAll)
                                        "
                                    >
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            {{ stockSectorPagination.from }}-{{
                                                stockSectorPagination.to
                                            }}
                                            /
                                            {{ stockSectorPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                ...
                                                :style="{
                                                    'pointer-events':
                                                        stockSectorPagination.current_page ==
                                                        1
                                                            ? 'none'
                                                            : '',
                                                }"
                                            ...
                                            <a
                                                ...
                                                :style="{
                                                    'pointer-events':
                                                        stockSectorPagination.last_page ==
                                                        stockSectorPagination.current_page
                                                            ? 'none'
                                                            : '',
                                                }"
                        ...
                        <b-modal
                            id="create"
                            :title="$t('StockSector.AddStockSector')"
                            title-class="font-18"
                            body-class="p-4 "
                            :hide-footer="true"
                            size="lg"
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody v-if="stockSectors.length > 0">
                                    <tr
                                        ...
                                        "
                                        v-for="(data, index) in stockSectors"
                                        :key="data.id"
