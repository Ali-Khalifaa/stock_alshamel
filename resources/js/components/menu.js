export const menuItems = [
    ...
    //     icon: "ri-share-line",
    //     link: "/arch-document-dtls",
    // },
    // {
    //     id: 16,
    //     label: "menuitems.ArchDocumentStatus.text",
    //     icon: "ri-share-line",
    //     link: "/arch-doc-status",
    // },

    {
        id: 7651,
        label: "general.HelpFiles",
        icon: "fas fa-sticky-note",
        isMenuCollapsed: false,
        subItems: [
            {
                id: 17,
                label: "menuitems.StockMarket.text",
                icon: "ri-share-line",
                link: "/stock-market",
            },
            {
                id: 19,
                label: "menuitems.StockSector.text",
                icon: "ri-share-line",
                link: "/stock-sector",
            },
        ]
    ...
    },
    {
        ...
        subItems: [
            {
                id: 22,
                label: "menuitems.OpenningBalance.text",
                icon: "ri-share-line",
                link: "/openning-balance",
            },
            {
                id: 20,
                label: "menuitems.StockSalePurchase.text",
                icon: "ri-share-line",
                link: "/stock-sale-purchase",
            },
            {
                id: 23,
                label: "menuitems.ClosingBalance.text",
                icon: "ri-share-line",
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                id: 25,
                label: "menuitems.ProfitReport.text",
                icon: "ri-share-line",
                link: "/profit-reports",
            },
            {
                id: 26,
                label: "menuitems.RealizedUnrealized.text",
                icon: "ri-share-line",
                link: "/realized-unrealized",
            },
        ]
    },
...

    {
        ...
        // label: "menuitems.OpenningBalance.text",
        // icon: "ri-share-line",
        link: "/openning-balance-edit/:id",
    },
    {
        id: 225353454,
        // label: "menuitems.OpenningBalance.text",
        // icon: "ri-share-line",
        link: "/closing-balance-edit/:date",
    },


    // {
    //     id: 3004325156,
    //     label: "general.stocks",
    //     icon: "fas fa-money-check-alt",
    //     isMenuCollapsed: false,
    //     subItems: [
    //         {
    //             id: 38887181,
    //             label: 'general.stockMarket',
    //             link: '/dashboard/stocks/stock-market'
    //         },
    //
    //     ]
    // },
